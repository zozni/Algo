...
#  한양대학교(Hanyang University)의 참여도를 수치화하였다. 창호가 보기에 세 대학교의 참여도의 합이
#   이상이면 일처리가 잘 되고 있기에 안심할 수 있지만, 100 미만이면 창호는 참여도가 가장 낮은 대학의 동아리에게
#   무언의 압박을 넣을 예정이다.
#  알고리즘 캠프의 성공을 빌며 창호의 고민을 해결해주자.
